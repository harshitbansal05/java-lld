...
import sa.com.barraq.events.*;
import sa.com.barraq.models.AccessDetails;
import sa.com.barraq.models.EvictionAlgorithm;
import sa.com.barraq.models.FetchAlgorithm;
import sa.com.barraq.models.Timer;
...
public class Cache<KEY, VALUE> {
    ...
    private final Map<KEY, CompletionStage<sa.com.barraq.models.Record<KEY, VALUE>>> cache;
    ...
    private CompletionStage<VALUE> getFromCache(KEY key) {
        final CompletionStage<sa.com.barraq.models.Record<KEY, VALUE>> result;
    ...
    private CompletionStage<sa.com.barraq.models.Record<KEY, VALUE>> addToCache(final KEY key, final CompletionStage<VALUE> valueFuture) {
        manageEntries();
